...
first_key = london_co['r1']
inbox_keys = first_key.keys()
print(inbox_keys)
a = str(inbox_keys)
a = a.replace('dict_keys','')
a = a.strip('([])')
print(a) 
#params = london_co.values()

dict_keys = input('Введите имя устройства: ')
dict_values = input('Введите имя параметра ('+a+'):')

print(london_co[dict_keys][dict_values.lower()])
