...
interface_name = input('Введите имя интерфейса:')
interface_vlan = input('Введите номер или номера vlan-ов:')

interface_type == 'access'

print('Interface '+interface_name)
print(access_template[0])
print('interface_vlan'.access_template[1].format())
print(access_template[2])
print(access_template[3])
print(access_template[4])

print(trunk_template[0])
print(f'interface_vlan'.trunk_template[1])
print(trunk_template[2])
